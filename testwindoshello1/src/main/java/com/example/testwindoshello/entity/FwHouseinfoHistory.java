...
@Entity
@Table(name = "fw_houseinfo_history", schema = "crebas", catalog = "")
public class FwHouseinfoHistory {
    private String houseinfohistoryid;
    ...
    @Id
    @Column(name = "houseinfohistoryid")
    public String getHouseinfohistoryid() {
        return houseinfohistoryid;
    }

    public void setHouseinfohistoryid(String houseinfohistoryid) {
        this.houseinfohistoryid = houseinfohistoryid;
    }
    ...
    public boolean equals(Object o) {
        ...
        FwHouseinfoHistory that = (FwHouseinfoHistory) o;
        return Objects.equals(houseinfohistoryid, that.houseinfohistoryid) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(houseinfohistoryid, userid, housedeclareid, systemid, islast, idsyfw, lvfwlbdm, lvfwytdm, lvfwcqxzzldm, lvczwbs, lvfwczyt, lvfwczmj, lvfwczjs, lvfzxm, lvfzgmsfhm, lvfzlxdh, lvtgrxm, lvtgrgmsfhm, lvtgrlxdh, wtglyxm, wtglygmsfhm, wtglylxdh, ifverify, verifytime, verifyperson, verifydesc, orgid, remark);
    }
}
