...
@Entity
@Table(name = "fw_resident", schema = "crebas", catalog = "")
public class FwResident {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(residentid, idsyrk, lvrylx, lvxm, lvzjhm, lvzjzl, lvgjhdqdm, lvywx, lvywm, lvxbdm, lvcsrq, hjdz, checkindate, leavedate, lvlxdh, systemid, idsyfw, djsj, houseinfoid);
    }
}
